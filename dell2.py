...
print(Fore.GREEN + '                         CMD    [1] lisergia : (Digite "lisergia" para Deletar mensagens mamaco)'.format(Fore.LIGHTRED_EX, Fore.LIGHTWHITE_EX))
print(Fore.GREEN + '                         CMD    [2] lisergia2 : (Digite "lisergia2" para Deletar todas mensagens da dm seu virgem )'.format(Fore.LIGHTRED_EX, Fore.LIGHTWHITE_EX))
print(''.format(Fore.LIGHTRED_EX, Fore.LIGHTWHITE_EX)) 
